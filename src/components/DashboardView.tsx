    ...
    <div className="bg-slate-50 min-h-screen pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 pb-6 border-b border-slate-200">
          <div>
            <div className="flex items-center space-x-2 text-xs font-semibold text-secondary-blue uppercase tracking-wider mb-2">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
              <span>Modo Demonstração do Produto</span>
            </div>
            <h1 className="font-display font-extrabold text-2xl sm:text-3xl text-primary-blue tracking-tight">
              Área do Cliente <span className="text-accent-gold font-light">| Portal Templus Pay</span>
            </h1>
            <p className="font-sans text-sm text-slate-500 mt-1">
              Visualize na prática a facilidade de antecipar faturas na nossa plataforma segura e homologada.
            </p>
          </div>
          <div className="mt-4 md:mt-0 flex items-center space-x-3">
            <button 
              onClick={handleResetInvoices}
              className="text-xs font-semibold text-slate-500 hover:text-primary-blue bg-white border border-slate-200 px-3 py-2 rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer"
            >
              <RefreshCw className="w-3.5 h-3.5" />
              Resetar Notas de Teste
            </button>
            <div className="bg-white border border-slate-200 shadow-sm rounded-xl px-4 py-2 flex items-center space-x-3">
              <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-primary-blue font-bold text-sm">
                JS
              </div>
              <div>
                <div className="text-xs font-bold text-primary-blue">Silva Comercial Ltda</div>
                <div className="text-[10px] text-slate-400 font-mono">CNPJ: 12.345.678/0001-90</div>
              </div>
            </div>
          </div>
        </div>
