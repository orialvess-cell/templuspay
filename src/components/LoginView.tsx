...
export default function LoginView({ onLoginSuccess, onBackToHome }: LoginViewProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // CNPJ: 12.345.678/0001-99 or Email: admin@templuspay.com.br
      // Senha: templus123
      const cleanCnpj = cnpj.replace(/\D/g, '');
      const isDemoCnpj = loginType === 'cnpj' && (cleanCnpj === '12345678000199' || cleanCnpj === '');
      const isDemoEmail = loginType === 'email' && (email === 'admin@templuspay.com.br' || email === '');
  ...
  const handleQuickFill = () => {
    ...
    if (loginType === 'cnpj') {
      ...
      setEmail('admin@templuspay.com.br');
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl space-y-3">
                ...
                <div className="space-y-1.5 text-xs text-slate-600 bg-white p-2.5 rounded-lg border border-slate-150 font-mono">
                  ...
                  <div><span className="font-sans font-semibold text-slate-400">E-mail:</span> admin@templuspay.com.br</div>
