    ...
    <footer className="bg-slate-900 text-white pt-20 pb-12 border-t border-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-slate-800">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm text-slate-400">
              <li>
                <button onClick={() => onNavClick('#simulator')} className="hover:text-accent-gold transition-colors cursor-pointer text-left">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-3 text-xs sm:text-sm text-slate-400">
              <li className="flex items-center space-x-2">
                ...
                <span className="font-mono">0800 591 1042</span>
              </li>
              <li className="flex items-center space-x-2">
                <MessageSquare className="w-4 h-4 text-accent-gold shrink-0" />
                <span className="font-mono">(11) 98765-4321 (WhatsApp)</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-accent-gold shrink-0" />
                <span className="font-sans">contato@templuspay.com.br</span>
              </li>
            </ul>
          </div>
        ...
        <div className="py-10 text-[10px] text-slate-500 leading-relaxed border-b border-slate-800 space-y-4">
          <p>
            <span className="font-bold text-slate-400">INFORMAÇÃO REGULATÓRIA IMPORTANTE:</span> O Templus Pay (Templus Pay Fomento Mercantil e Tecnologia S/A, CNPJ 45.678.901/0001-23) não é uma instituição financeira bancária. Atuamos como uma plataforma digital de fomento comercial e correspondente bancário em estrita conformidade com as diretrizes da Resolução CMN nº 4.935 de 03 de dezembro de 2021 do Banco Central do Brasil.
          </p>
          <p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          <p>© {currentYear} Templus Pay. Todos os direitos reservados. Feito com rigor tecnológico e profissionalismo.</p>
