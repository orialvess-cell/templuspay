            ...
            {currentView === 'landing' ? (
              <>
                ...
                <button
                  ...
                  className="font-sans font-semibold text-sm text-white bg-primary-blue hover:bg-secondary-blue px-5 py-2.5 rounded-xl shadow-md shadow-primary-blue/10 hover:shadow-lg transition-all cursor-pointer border border-primary-blue hover:border-secondary-blue"
                  id="btn-open-account"
                >
                  Abra sua Conta
                </button>
              ...
              {currentView === 'landing' ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full text-center px-4 py-3 rounded-xl bg-primary-blue text-white font-sans font-semibold shadow-md shadow-primary-blue/10 hover:bg-secondary-blue"
                  >
                    Abra sua Conta
                  </button>
                </>
